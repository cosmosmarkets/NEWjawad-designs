...
(function(){
  ...
  .e-hero-ring img{width:100%;height:100%;object-fit:cover;object-position:50% 30%;display:block;}
  ...
  .e-hero2 .e-hero-ring img{width:100%;height:100%;object-fit:cover;object-position:50% 30%;display:block;}
  ...
  const SECTIONS=[
    ...
    {id:'pricing',ix:'06',tag:'PRICING',title:'3 packages.',w:600,h:268,route:'pricing',cls:'e-pricing',say:'open pricing ↗',dwellMs:250,
     body:`<div class="e-tiers">
       <div class="e-tier"><span class="e-tier-name">The Single</span><span class="e-tier-price">from $500</span></div>
       <div class="e-tier is-pop"><span class="e-tier-badge">★ popular</span><span class="e-tier-name">The Edition</span><span class="e-tier-price">from $1,200</span></div>
       <div class="e-tier"><span class="e-tier-name">The Commission</span><span class="e-tier-price">from $3,000</span></div>
     </div>
     ...
     note:['Pricing','Three frosted tier chips — The Single / The Edition / The Commission — opens /pricing; the popular tier lifts on settle. Badges off by default (Tweaks toggle).']},
    {id:'contact',ix:'06',tag:'CONTACT',title:'',w:1040,h:460,open:'contact',cls:'e-slab e-on-dark',say:'open contact ↗',dwellMs:250,
     ...
     pvDetail:'contact',
     prev:pv('/contact', `<div style="flex:1;">${bars(['100%'])}</div><div class="e-pv-row">${ghost('name','flex:1;height:38px;')}${ghost('email','flex:1;height:38px;')}</div>${ghost('message','height:56px;')}<div class="e-cta primary" style="align-self:flex-start;">Send it ▸</div>`),
     note:['Contact','The dark slab — Your move., one CTA to /contact, email baseline. Click match-cuts into the nested enquiry form. Terminal panel: advancing loops back to the hero.']},
  ];
